(function (global, factory) {
    ...
    const hexToRgb = (e) => {
        ...
        const o = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(
            t.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i, (e, t, o, r) => t + t + o + o + r + r),
        );
    ...
    const getStoreSpace = (e = localStorage) =>
        parseFloat((escape(encodeURIComponent(JSON.stringify(e))).length / 1048576).toFixed(2));
                ...
                new DomNode(e).on('click', () => {
                    ('indeterminate' !== this.element.indeterminate &&
                        ...
                        [...this.bulkSelectRows].every((e) => e.checked) &&
                            ((this.element.indeterminate = !1), this.element.setAttribute('indeterminate', !1)),
                        [...this.bulkSelectRows].every((e) => !e.checked) &&
                        ...
                        const i = () => {
                            e.querySelectorAll('.choices').forEach((e) => {
                                ...
                                if (
                                    ...
                                    (i &&
                                        ('' !==
                                        i.querySelector('.choices__item--selectable')?.getAttribute('data-value')
                ...
                (c.addListener('click', () => {
                    ...
                    t &&
                        t.addEventListener('clickControl', ({ detail: { control: e, value: t } }) => {
                            'phoenixTheme' === e &&
                                f.set('styles', 'dark' === t ? s.SnazzyCustomDark : s.SnazzyCustomLight);
                        }));
            });
        }
    }
                    ...
                    t.forEach((t) => {
                        ...
                        const v = () => {
                            (c &&
                                ...
                                p > 1 &&
                                    p < m &&
                                    (togglePaginationButtonDisable(i, !1), togglePaginationButtonDisable(s, !1)));
                        };
                        (v(),
                            i &&
            ...
            Array.from(t).forEach((t) => {
                const o = e(t, 'picmo'),
                    n = window.picmoPopup.createPopup(
                        {},
                        { referenceElement: t, triggerElement: t, position: 'bottom-start', showCloseButton: !1 },
                    );
    ...
    const getThubmnailDirection = () =>
            window.innerWidth < 768 || (window.innerWidth >= 992 && window.innerWidth < 1200)
                ? 'horizontal'
                : 'vertical',
        productDetailsInit = () => {
            ...
            e &&
                e.querySelectorAll('[data-theme-control]').forEach((e) => {
                    ...
                    if (
                        ...
                        'phoenixTheme' === n
                            ? ('auto' === r ? 'dark' === o() : 'dark' === r) && e.setAttribute('checked', !0)
        ...
        (initialDomSetup(n.node),
            n.on('click', (e) => {
                ...
                if (d.data('theme-control')) {
                    ...
                    switch (
                        ('true' === new URLSearchParams(window.location.search).get('theme-control') &&
            ...
            (h.forEach((e) => {
                e.addEventListener(
                    ...
                    (t) => (
                        ...
                        (m &&
                            v &&
                            (m.value !== v.value ? v.setCustomValidity('Invalid field.') : v.setCustomValidity('')),
                        !e.checkValidity())
                            ? (q.preventDefault(), !1)
                            : ((E += 1), null)
                    ),
                    ...
                    b.forEach((t, a) => {
                        (t.addEventListener(c, (a) => {
                            ...
                            t.addEventListener(u, () => {
                                ...
                                for (let e = 0; e < E; e += 1)
                                    (b[e].classList.add('done'), e > 0 && b[e - 1].classList.add('complete'));
                                for (let e = E; e < b.length; e += 1)
                                    (b[e].classList.remove('done'), e > 0 && b[e - 1].classList.remove('complete'));
            ...
            o &&
                o.forEach((o) => {
                    ...
                    if (n) {
                        ...
                        (o.center &&
                            new window.mapboxgl.Marker({ color: getColor('danger') }).setLngLat(o.center).addTo(m),
                            r &&
                                a &&
        ...
        e &&
            e.forEach((e) => {
                ...
                (t.addEventListener('change', (t) => {
                    ((r[0].checked = !0),
                        t.target.checked ? e.classList.add('active') : (e.classList.remove('active'), c.hide()));
                }),
                    r.forEach((e) => {
            ...
            t.forEach((t) => {
                ...
                e.addEventListener('click', () => {
                    'password' === s.type
                        ...
                        : (s.setAttribute('type', 'password'), e.classList.remove('show-password'));
                });
            });
    };
