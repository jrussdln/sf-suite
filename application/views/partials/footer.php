...
<script>
  ...
  $(document).ready(function() {
    ...
    const toggleBtn = document.getElementById('togglePasswordIconDesktop');
    const input = document.getElementById('passwordInputDesktop');
    const eye = toggleBtn.querySelector('.uil-eye');
    const eyeSlash = toggleBtn.querySelector('.uil-eye-slash');
