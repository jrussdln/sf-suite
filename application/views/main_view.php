        ...
        function loadContent(url) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    // If the loaded content contains #calendar, initialize it
                    if ($('#dynamic-content #calendar').length) {
                        if (typeof window.initAttendanceCalendar === 'function') {
                            window.initAttendanceCalendar();
                        } else {
                            console.error('initAttendanceCalendar() not found');
                        }
                    }
                },
                error: function() {
...
<script>
window.initAttendanceCalendar = function() {
    var calendarEl = document.querySelector('#dynamic-content #calendar');
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        events: "<?= base_url('academic/getEvents'); ?>",
        headerToolbar: {
        ...
        eventDidMount: function(info) {
            // Set professor as tooltip
            if (info.event.extendedProps.professor) {
                info.el.setAttribute("title", info.event.extendedProps.professor);
            }
        }
    });
    calendar.render();
